...
// Se puede ejecutar manualmente con: npm run cargar-menu
// También se llama automáticamente al arrancar el servidor (server.js),
// así que es seguro correrlo varias veces: no duplica productos ya existentes.
const db = require('../db');
...
// Si se ejecuta directamente con "node src/scripts/cargarMenuMikuyNina.js" o "npm run cargar-menu"
